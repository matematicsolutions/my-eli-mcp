...
SOURCE = 'lom.agc.gov.my (Laws of Malaysia Online)'
...
_FAMILIES: list[dict] = [{'name': 'Federal principal Acts', 'tool': 'my_get_act / my_get_text'}]

_GAPS: list[dict] = [{'id': 'MY-001', 'family': 'Federal principal Acts', 'missing': 'Principal Acts only - amendments (A-codes) and subsidiary legislation (P.U. instruments) are not covered.', 'fallback': 'Use the lom.agc.gov.my portal for amendments and subsidiary legislation.'}, {'id': 'MY-002', 'family': 'Federal principal Acts', 'missing': 'Malaysia has not deployed ELI; eli_uri is the durable lom.agc.gov.my act page URL.', 'fallback': "Treat eli_uri as the portal's own act permalink."}, {'id': 'MY-003', 'family': 'Federal principal Acts', 'missing': 'State legislation is out of scope - this is federal law.', 'fallback': "Use the relevant state's own gazette."}]
